...
//        return [[cellClass alloc] initWithStyle:style reuseIdentifier:NSStringFromClass(cellClass)];
        ...
        if ([[field valueForKey:FXFormFieldValidate]isEqual:@YES]) {
            cell.textLabel.textColor = [UIColor colorWithRed:1.0 green:0 blue:0 alpha:0.7];
        }else{
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    // to fix bug of not appearing in iOS7
