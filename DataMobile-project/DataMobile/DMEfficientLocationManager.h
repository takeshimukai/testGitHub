...
#import "DMModepromptManager.h"  // Modified by MUKAI Takeshi in 2015-12
...
@property (nonatomic, retain) DMModepromptManager *modepromptManager;  // Modified by MUKAI Takeshi in 2015-12
