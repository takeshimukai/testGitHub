...
- (void)locationDataSource:(id)dataSource didStartMonitoringRegionOnAppTerminatedWithCenter:(CLLocationCoordinate2D)center radius:(CLLocationDistance)radius;  // region onAppterminated
- (void)locationDataSourceStoppedMonitoringRegionOnAppTerminated;  // region onAppterminated
@end
