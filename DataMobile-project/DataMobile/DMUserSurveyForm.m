...
- (NSArray*)fields {
    return @[
             @{FXFormFieldKey: DM_SEX_FIELD_KEY,
               FXFormFieldOptions: DM_SEX_OPTIONS,
               FXFormFieldInline: @YES},
             
             @{FXFormFieldKey: DM_AGE_FIELD_KEY,
               FXFormFieldOptions: DM_AGE_OPTIONS,
               FXFormFieldInline: @YES},
             
             @{FXFormFieldKey: DM_LICENCE_XOR_TRANSIT_FIELD_KEY,
               FXFormFieldHeader: @"Do you have a driver's license and/or\na monthly transit pass?",
               FXFormFieldTitle: @"",
               FXFormFieldOptions: @[@"Driver's License",
                                     @"Monthly Transit Pass"],
               FXFormFieldType: FXFormFieldTypeBitfield,
               FXFormFieldInline: @YES},
             
             @{FXFormFieldKey: DM_LIVING_ARRANGEMENT_KEY,
               FXFormFieldOptions: DM_LIVING_ARRANGEMENT_OPTIONS,
               FXFormFieldTitle: @"Who do you live with?",
               FXFormFieldInline: @YES},
                   
             @{FXFormFieldKey: DM_TOTAL_PEOPLE_FIELD_KEY,
               FXFormFieldHeader: @"How many people live in your home?",
               FXFormFieldTitle: @"",
               FXFormFieldCell: [FXFormStepperCell class]},
             
             @{FXFormFieldKey: DM_YOUNG_PEOPLE_FIELD_KEY,
               FXFormFieldTitle: @"",
               FXFormFieldHeader: @"How many are under 16?",
               FXFormFieldCell: [FXFormStepperCell class]},
             
             @{FXFormFieldKey: DM_TOTAL_CARS_FIELD_KEY,
               FXFormFieldHeader: @"How many cars are in your home?",
               FXFormFieldTitle: @"",
               FXFormFieldCell: [FXFormStepperCell class]},
