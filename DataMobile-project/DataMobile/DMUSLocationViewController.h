...
@interface DMUSLocationViewController : UIViewController<LocationMapViewDelegate> {
    NSString *segueID;
    int mType;
}

@property (nonatomic, retain) DMUSDataManager *usDataManager;
@property (nonatomic, retain) LocationMapViewController *locationMapViewController;
