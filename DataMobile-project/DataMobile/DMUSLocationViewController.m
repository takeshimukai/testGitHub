...
@synthesize btnNext, naviItem, labelText;
...
- (void)setViewProperty
{
    if (usDataManager.memberType==0||usDataManager.memberType==1||(usDataManager.memberType==3&&!usDataManager.isWorkInfoEnded)) {
        // work
        mType = 1;
        naviItem.title = @"Work Location";
        labelText.text = @"Please indicate your approximate\nwork location.";
        segueID = @"usTravelSegue";
    }else if (usDataManager.memberType==2||(usDataManager.memberType==3&&usDataManager.isWorkInfoEnded)) {
        // study
        mType = 2;
        naviItem.title = @"Study Location";
        labelText.text = @"Please indicate your approximate\nstudy location.";
        segueID = @"usTravelSegue";
    }else{
        // home
        mType = 0;
        naviItem.title = @"Home Location";
        labelText.text = @"Please indicate your approximate\nhome location.";
