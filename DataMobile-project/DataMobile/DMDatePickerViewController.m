...
- (UIDatePicker*)datePicker {
    if (!_datePicker) {
        ...
        _datePicker.frame = CGRectMake(self.datePicker.frame.origin.x, self.datePicker.frame.origin.y, self.customRangeStartCell.frame.size.width, self.datePicker.frame.size.height); // Modified by MUKAI Takeshi in 2015-10 // to diaplay center on iPad correctly
